...
Walletbutton.addEventListener("click", () => {
  ...
  image.src =
    "https://www.zoomcar.com/build/760ee3019ff287f2caed7e40c92b1ca5.png";
...
NETbankingbutton.addEventListener("click", () => {
  ...
  let image1 = document.createElement("img");
  image1.src =
    "https://zoomcar-assets.zoomcar.com/images/original/27eac78721d3d14bc9df34231bce661e1d510e8f.png?1584602001";
  ...
  image2.src =
    "https://zoomcar-assets.zoomcar.com/images/original/f380ffaa7f80bdc586f469a53a3caea8887d84a4.png?1584601955";
  ...
  image3.src =
    "https://zoomcar-assets.zoomcar.com/images/original/312f0e8f319287aa09b1e96b45a7d82cabf6184a.png?1584601979";
  ...
  image4.src =
    "https://zoomcar-assets.zoomcar.com/images/original/d79d466d40fc7df794e2e1c907db212e52d4f47f.png?1584601931";
...
function servercall(total, token) {
  ...
  obj = { amount, plan };
  fetch(
    "https://vlink-auth-server.onrender.com/user/sendmail",
    {
      method: "POST",
      headers: {
