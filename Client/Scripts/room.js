...
if (type == "message") {
    title.innerText = `VLink Chat Platform`
} else if (type == "videochat") {
    title.innerText = `Vlink Video Chat Platform`
} else {
    title.innerText = `VLink Meeting Platform`
}
        ...
        try {
            ...
            if (res.ok) {
                if (type == "message") {
                    ...
                    window.location.href = `./videocall.html?type=${type}&roomID=${room}`
                }
        ...
        try {
            ...
            if (response.ok) {
                if (type == "message") {
                    ...
                    window.location.href = `./videocall.html?type=${type}&roomID=${roomID}`;
                }
            } else {
                Swal.fire({
                    icon: 'error',
